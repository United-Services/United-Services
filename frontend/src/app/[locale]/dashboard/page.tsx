...
// your own DB").
export default async function DashboardRedirectPage({ params }: { params: Promise<{ locale: AppLocale }> }) {
  ...
  try {
    ...
    if (me.role === 'admin') redirect({ href: me.mfaEnrolled ? '/admin-dashboard' : '/admin-mfa-setup', locale })
