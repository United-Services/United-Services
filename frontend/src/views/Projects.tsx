...
const COMPANIES: Company[] = [
  {
    slug: 'adnoc', name: 'ADNOC', logo: adnocLogo,
    projects: [
  ...
  {
    slug: 'eni', name: 'ENI', logo: eniLogo,
    projects: [
  ...
  {
    slug: 'petrobel', name: 'Petrobel', logo: petrobelLogo,
    projects: [
  ...
  {
    slug: 'apache', name: 'Apache', logo: apacheLogo,
    projects: [
      { key: 'p1', tag: 'coating', year: '2023', img: IMG.coating },
  ...
  {
    slug: 'bapetco', name: 'Bapetco', logo: bapetcoLogo,
    projects: [
      { key: 'p1', tag: 'rtp', year: '2022', img: IMG.rtp },
  ...
  {
    slug: 'khalda', name: 'Khalda', logo: khaldaLogo,
    projects: [
  ...
  {
    slug: 'agiba', name: 'Agiba', logo: agibaLogo,
    projects: [
      { key: 'p1', tag: 'gre', year: '2022', img: IMG.pipes },
  ...
  {
    slug: 'osoco', name: 'OSOCO', logo: ososcoLogo,
    projects: [
      { key: 'p1', tag: 'coating', year: '2021', img: IMG.coating },
  ...
  {
    slug: 'dara', name: 'Dara', logo: daraLogo,
    projects: [
      { key: 'p1', tag: 'rtp', year: '2023', img: IMG.rtp },
    ],
  },
  {
    slug: 'shell', name: 'Shell', logo: shellLogo,
    projects: [
      { key: 'p1', tag: 'coating', year: '2020', img: IMG.coating },
    ],
  },
  {
    slug: 'qarun', name: 'Qarun', logo: qarunLogo,
    projects: [
      { key: 'p1', tag: 'wrap', year: '2021', img: IMG.weld },
    ],
  },
  {
    slug: 'qp', name: 'QP', logo: qpLogo,
    projects: [
      { key: 'p1', tag: 'gre', year: '2022', img: IMG.pipes },
    ],
  },
  {
    slug: 'west', name: 'West', logo: westLogo,
    projects: [
      { key: 'p1', tag: 'hdpe', year: '2020', img: IMG.hdpe },
    ],
  },
  {
    slug: 'petrosilah', name: 'Petrosilah', logo: petrosilahLogo,
    projects: [
      { key: 'p1', tag: 'rtv', year: '2019', img: IMG.refinery },
    ],
  },
]
      ...
      <section style={{ position: 'relative', paddingTop: 68, background: palette.navy, padding: '120px 28px 80px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 1260, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 17, color: '#94A3B8', maxWidth: 560, lineHeight: 1.7 }}>
            {filter ? t('subtitleWithCompany', { company: filter }) : t('subtitle')}
          </p>
          {filter && (
            <button
            ...
            <div key={c.name} className="reveal">
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24, paddingBottom: 16, borderBottom: '1px solid #E2E8F0' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: palette.muted }}>{t(`companies.${c.slug}.region` as any)}</div>
                </div>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 24 }}>
                {c.projects.map((p) => (
                  <div key={p.key} style={{ border: '1px solid #E2E8F0', borderRadius: 16, overflow: 'hidden' }}>
                    <img src={p.img} alt={t(`companies.${c.slug}.projects.${p.key}.title` as any)} style={{ width: '100%', aspectRatio: '16/9', objectFit: 'cover' }} />
                    <div style={{ padding: '20px 22px' }}>
                      ...
                      <div style={{ fontSize: 16, fontWeight: 700, color: palette.navy, marginBottom: 8 }}>{t(`companies.${c.slug}.projects.${p.key}.title` as any)}</div>
                      <p style={{ fontSize: 13, color: palette.slate, lineHeight: 1.6 }}>{t(`companies.${c.slug}.projects.${p.key}.desc` as any)}</p>
                    </div>
                  </div>
                ))}
              </div>
