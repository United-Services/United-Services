    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, rgba(15,23,42,0.72) 0%, rgba(15,23,42,0.55) 50%, rgba(15,23,42,0.92) 100%)",
            }}
          />
          <div
            style={{
              ...
              >
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                      d="M8 1l1.8 3.6 4 .6-2.9 2.8.7 4L8 10.1 4.4 12l.7-4L2.2 5.2l4-.6z"
                      fill={palette.accent}
                    />
                  </svg>
                </div>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(90deg, rgba(15,23,42,0.88) 0%, rgba(15,23,42,0.5) 60%, rgba(15,23,42,0.2) 100%)",
            }}
          />
          <div
            style={{
        ...
        <section style={{ background: "#fff", padding: "100px 28px" }}>
          ...
          >
            <div className="reveal-left">
              <img
                src={ldImg}
                alt="Close-up cross-section of a pipeline showing coating and corrosion layers"
                style={{
                  width: "100%",
                  aspectRatio: "16/10",
                  objectFit: "cover",
            ...
            <div className="reveal-right">
              ...
              <p
                style={{ fontSize: 16, color: palette.slate, lineHeight: 1.7 }}
              >
              ...
              {[
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    el.style.boxShadow = "0 12px 48px rgba(0,0,0,0.1)"
                ...
                >
                  ...
                  >
                    <img
                      src={step.img}
                      alt={t(`methodology.${step.key}.title` as any)}
                      style={{
                        width: "100%",
                        height: "100%",
                        objectFit: "cover",
                    ...
                    >
                      {t(`methodology.${step.key}.title` as any)}
                    </div>
                  </div>
                  <div style={{ padding: "24px 24px" }}>
                    ...
                    >
                      {t(`methodology.${step.key}.desc` as any)}
                    </p>
                  </div>
                </div>
              ))}
        ...
        <section style={{ background: "#fff", padding: "80px 0" }}>
          <div
            style={{ textAlign: "center", marginBottom: 48, padding: "0 28px" }}
          >
            <div
              style={{
                fontSize: 11,
            ...
            <p style={{ fontSize: 14, color: palette.muted }}>
              ADNOC · BP · Shell · ENI · Petrobel · Apache · Bapetco · Khalda ·
              Qarun · QP · Agiba · OSOCO · West · Petrosilah · Dara
            </p>
          </div>
