...
// account (super_admin counts as admin here — see lib/adminRoles.ts) can
// never reach the enrollment shell by navigating here directly, and an
// admin who has already enrolled is sent to the per-session MFA challenge
// instead (further MFA management happens from AdminSecuritySection
// inside the dashboard, not here).
